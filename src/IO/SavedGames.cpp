...
void loadGame(SavedGameInfo* savedGame)
{
    ...
    // FIXME: Actually grab the game state and load it!
    ...
    bool loadSucceeded = loadSaveFile(&saveFile);
    closeFile(&saveFile);
...
bool saveGame(String saveName)
{
    ...
    // FIXME: Actually pass in game state here to save it!
    bool saveSucceeded = writeSaveFile(&saveFile);
    closeFile(&saveFile);
